...
<div class="w3-display-position w3-margin-left w3-padding w3-third"  style="top:220px;left:400px">
...
<table>
  ...
  <tr>
    ...
    <input type="hidden" name="price" value="<?php echo $row['service_provider']; ?>">
    ...
    <td><button type="submit"name="btn" class="w3-button w3-white w3-border w3-round"onclick="myFunction()">DELETE</button></td>
    </form>
  </tr>
  <?php  
      $sum=$sum+$row['price'];     //mysqli_free_result($result);
      }
      ?>
   ...
   <br>
    ...
    <button class="w3-button w3-grey w3-border w3-round-large" name="confirm"onclick="confirm()">Confirm!</button>
...
<script>
function myFunction() {
  alert("The service has been deleted from your cart");
...
function confirm() {
  alert("The services have been confirmed");
